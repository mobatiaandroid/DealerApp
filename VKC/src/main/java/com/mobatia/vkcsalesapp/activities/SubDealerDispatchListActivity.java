...
public class SubDealerDispatchListActivity extends AppCompatActivity implements
        VKCUrlConstants {
    Activity mActivity;
    Bundle extras;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStatusList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new
                        Intent(SubDealerDispatchListActivity.this, DispatchedListDetail.class);
                intent.putExtra("tranporter_name", AppController.subDealerModels.get(position).getName());
                intent.putExtra("transporter_contact", AppController.subDealerModels.get(position).getPhone());
                intent.putExtra("order_id", AppController.subDealerModels.get(position).getOrderid());
                intent.putExtra("order_date", AppController.subDealerModels.get(position).getOrderDate());
    ...
    private void getSalesOrderStatus(String listType) {
        ...
        manager.getResponsePOST(this, name, values, new ResponseListener() {
            ...
            public void responseFailure(String failureResponse) {
                VKCUtils.showtoast(SubDealerDispatchListActivity.this, 17);
